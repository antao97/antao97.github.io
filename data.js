...
var paper = {
	lgm: {
		...
		intro_zh: [
			"目前的对抗攻击方法默认网络在攻击前后网络结构不会发生变化，但是此假设并不适用于很多近期提出的自适应神经网络，这些自适应神经网络会根据不同的输入数据自适应地关闭一些不重要的运算单元，导致目前的攻击方法在新的网络结构中变得无效。",
			"我们第一个发现了自适应神经网络在对抗攻击中的滞后问题，对代表性的自适应神经网络在二维图像和三维点云上进行了动态感知对抗攻击的研究，其中三维稀疏卷积网络在三维点云处理中占据了重要地位。"
		]
  	},
	seggroup: {
		short_name: "SegGroup",
